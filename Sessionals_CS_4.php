<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`4semcomses` (`Rollno`, `GSED`, `DSA`, `OOPS`, `SE`, `Microprocessors`, `CN`) VALUES ('$rollno', '$GSED', '$DSA', '$OOPS', '$SE', '$Microprocessor', '$CN')";
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <div class="container box_shadow">
                <form action="Sessionals_CS_4.php" method = "post">
