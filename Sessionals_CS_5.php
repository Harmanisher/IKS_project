<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`5semcomses` (`Rollno`, `CPI`, `Java`, `IWT`, `ADBMS`, `WC`) VALUES ('$rollno', '$CPI', '$Java', '$IWT', '$ADBMS', '$WC')";
...
<body>
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <form action="Sessionals_CS_5.php" method = "post">
                    ...
                    <div class="input">
                        <label for="">Computer peripherals and interfacing: </label><input type="number" name = "CPI" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        <label for="">ADBMS: </label><input type="number" name = "ADBMS" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
