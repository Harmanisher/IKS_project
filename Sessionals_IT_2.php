<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`2semitses` (`Rollno`, `English`, `Maths`, `Physics`, `BEE`, `BE`) VALUES ('$rollno', '$English', '$Maths', '$Physics', '$BEE', '$BE')";
...
<body>
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <form action="Sessionals_IT_2.php" method = "post">
