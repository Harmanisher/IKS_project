<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`2semcomses` (`Rollno`, `English`, `Maths`, `Physics`, `BEE`, `BE`) VALUES ('$rollno', '$English', '$Maths', '$Physics', '$BEE', '$BE')";
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <div class="container box_shadow">
                <form action="Sessionals_CS_2.php" method = "post">
                    <h2>2nd Sem Students</h2>
                    <div class="input">
                    ...
                    <div class="input">
                        <label for="">Applied_Maths2: </label><input type="number" name = "Maths" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Applied-Physics2: </label><input type="number" name = "Physics" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Basic of Electrical Engineering: </label><input type="number" name = "BEE" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Basics Electronics: </label><input type="number" name = "BE" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
