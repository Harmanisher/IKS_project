<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`1semcomses` (`Rollno`, `English`, `Maths`, `Physics`, `BIT`, `EngineeringDrawing`) VALUES ('$rollno', '$English', '$Maths', '$Physics', '$BIT', '$EngineeringDrawing')";
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <div class="container box_shadow">
                <form action="Sessionals_CS_1.php" method = "post">
