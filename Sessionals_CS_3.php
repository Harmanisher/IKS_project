<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`3semcomses` (`Rollno`, `DE`, `C`, `RDBMS`, `OS`, `Multimedia`) VALUES ('$rollno', '$DE', '$C', '$RDBMS', '$OS', '$Multimedia')";
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <div class="container box_shadow">
                <form action="Sessionals_CS_3.php" method = "post">
