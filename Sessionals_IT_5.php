<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`5semitses` (`Rollno`, `Java`, `WC`, `IWT`, `STQA`, `Ecommerce`) VALUES ('$rollno', '$Java', '$WC', '$IWT', '$STQA', '$Ecommerce')";
...
<body>
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <form action="Sessionals_IT_5.php" method = "post">
                    <h2>5th Sem Students</h2>
                    <div class="input">
                    ...
                    <div class="input">
                        <label for="">Java programming: </label><input type="number" name = "Java" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Wireless communication: </label><input type="number" name = "WC" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Internet and web technologies: </label><input type="number" name = "IWT" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">Software testing and quality assurance: </label><input type="number" name = "STQA" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
                    <div class="input">
                        <label for="">E-commerce: </label><input type="number" name = "Ecommerce" min="0" max="30" oninput="checkMaxValue(this)">
                    </div>
