<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(!$con){
            ...
            $sql = "INSERT INTO `uploadsessionals`.`6semitses` (`Rollno`, `BOM`, `VB.Net`, `ADBMS`, `MC`, `AI`) VALUES ('$rollno', '$BOM', '$VBNet', '$ADBMS', '$MC', '$AI')";
...
<body>
    ...
    <main>    
        ...
        <div id="sessionals">
            ...
            <form action="Sessionals_IT_6.php" method = "post">
